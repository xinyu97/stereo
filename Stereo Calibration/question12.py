...
def main():
    ...
    def calibrateCamera(chessboards):
        ...
        return np.array(R), np.array(_tvecs),newcameramtx

    R_left,t_left,cameramtx_left = calibrateCamera(chessboards_left)
    R_right,t_right,cameramtx_right = calibrateCamera(chessboards_right)
    ...
    for i in range(len(R)):
        print('第',i,'组',file=data)
        print('R=',R[i],file=data)
        print('t=',t[i],file=data)
